...
// TODO Auto-generated method stub
    ...
    public String actualizar(Usuario usuario) {
        if (true){//si existe el usuario con dui xxx
    ...
    public String actualizar(Zona zona) {
        if (true){//si existe el zona con id xxx
    ...
    public String actualizar(CategoriaProdServ categoriaProdServ){return "";}
    public String eliminar(CategoriaProdServ categoriaProdServ){return "";}
    public CategoriaProdServ consultarCategoriaProdServ(int idCategoriaProd){return null;}
    /***********************CRUD PROD SERV***************************************/
    public String insertar(ProdServ prodServ){
        ...
        return regInsertados;}
    public String actualizar(ProdServ prodServ){return "";}
    public String eliminar(ProdServ prodServ){return "";}
    public ProdServ consultarProdServ(int idProdServ){return null;}
    /*****************************CRUD ESTADO RECLAMO******************************/
    ...
    public String actualizar(EstadoReclamo estadoReclamo){return "";}
    public String eliminar(EstadoReclamo estadoReclamo){return "";}
    public EstadoReclamo consultarEstadoReclamo(int idEstadoReclamo){return null;}
    ...
    public String actualizar(DetalleReclamo detalleReclamo){return "";}
    public String eliminar(DetalleReclamo detalleReclamo){return "";}
    public DetalleReclamo consultarDetalleReclamo(int idDetaleReclamo){return null;}
    /*****************************CRUD RECLAMO**************************************/
    ...
    public String actualizar(Reclamo reclamo){return "";}
    public String eliminar(Reclamo reclamo){return "";}
    public Reclamo consultarReclamo(int idReclamo){return null;}
    /***************************CRUD EMPRESA*****************************************/
    ...
    public String actualizar(Empresa empresa){return "";}
    public String eliminar(Empresa empresa){return "";}
    public Reclamo consultarEmpresa(int idEmpresa){return null;}
    ...
    public String actualizar(CategoriaEmpresa categoriaEmpresa){return "";}
    public String eliminar(CategoriaEmpresa categoriaEmpresa){return "";}
    public Reclamo consultarCategoriaEmpresa(int idCategoriaEmpresa){return null;}
    /***************************CRUD SUCURSAL****************************************/
    ...
    public String actualizar(Sucursal sucursal){return "";}
    public String eliminar(Sucursal sucursal){return "";}
    public Reclamo consultarSucursal(int idSucursal){return null;}
    /********************************************************************************/
